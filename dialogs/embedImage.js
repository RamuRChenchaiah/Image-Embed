 ...
 */
CKEDITOR.dialog.add("embedImageDialog", function(editor){
                ...
                elements: [
                    {
                        type: "text",
                        id: "alt",
                        label: editor.lang.embedImage.alt
                    },
                    {
						type: 'hbox',
						widths: ["15%", "15%", "70%"],
						children: [
							...
							},
							{
								type: "checkbox",
								id: "lock",
								label: editor.lang.embedImage.lockRatio,
                    ...
                    },
					{
						...
						children: [
							...
							},
							{
								...
								width: "45px",
								id: "vmargin",
								label: editor.lang.embedImage.vSpace
							},
							{
								type: "text",
								width: "45px",
								id: "hmargin",
								label: editor.lang.embedImage.hSpace
							},
							{
								type: "text",
								width: "45px",
								id: "border",
								label: editor.lang.embedImage.border
							}
						]
					}
                ]
